          ...
          <nav className="sidebar-nav" aria-label="Primary">
            ...
            {user?.role === 'STUDENT' && (
              <>
                ...
                <NavLink to="/placements" className={({ isActive }) => `nav-link ${isActive ? 'is-active' : ''}`}>
                  Placement
                </NavLink>
                <NavLink to="/training" className={({ isActive }) => `nav-link ${isActive ? 'is-active' : ''}`}>
                  Training
                </NavLink>
            ...
            {user?.role === 'VOLUNTEER' && (
              <>
                <NavLink to="/students" className={({ isActive }) => `nav-link ${isActive ? 'is-active' : ''}`}>
                  Students Directory
                </NavLink>
                <NavLink to="/placements" className={({ isActive }) => `nav-link ${isActive ? 'is-active' : ''}`}>
