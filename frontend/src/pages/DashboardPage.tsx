      ...
      <div style={{ display: 'grid', gap: 'var(--space-lg)' }}>
        <section className="page-header">
          <div>
            ...
            <p className="text-secondary">
              Welcome back, {user?.first_name}. Track your placement readiness, schedules,
              and active opportunities.
            </p>
          </div>
          <Link to="/profile" className="btn-primary button-link">
            View My Profile
          </Link>
        </section>
        ...
        <section className="dashboard-grid">
          ...
          <article className="card" style={{ display: 'grid', gap: '12px' }}>
            ...
            <p className="text-secondary">
              Complete all checklist items to be eligible for campus recruitments.
            </p>
            ...
            <div className="circular-progress-wrapper" style={{ margin: '14px 0' }}>
              ...
              >
                ...
                />
                <path
                  className="circle circle-success"
              ...
              <div>
                ...
                <p className="text-secondary" style={{ fontSize: '13px', margin: 0 }}>
                  Your academic records and grades are verified. Upload your latest resume
                  to reach 100% readiness and unlock applications.
                </p>
              </div>
            </div>

            <ul className="action-list">
              <li style={{ borderLeftColor: 'var(--color-accent)' }}>
                Academic Grades verified by HOD
              </li>
              <li style={{ borderLeftColor: 'var(--color-accent)' }}>
                Compliance documents (Aadhaar/PAN) uploaded
              </li>
              <li style={{ borderLeftColor: 'var(--color-warning)' }}>
                Upload latest professional resume (PDF format)
              </li>
            </ul>
          </article>
          ...
          >
            <h2>Quick Actions</h2>
            <p className="text-secondary">
              Jump directly to your active portal workspaces.
            </p>
      ...
      <div style={{ display: 'grid', gap: 'var(--space-lg)' }}>
        <section className="page-header">
          <div>
            <h1>Volunteer Hub</h1>
            <p className="text-secondary">
              Track student records, verify document collection lists, and manage turnout
              rosters.
            </p>
          </div>
          <Link to="/students" className="btn-primary button-link">
        ...
        <section className="dashboard-grid">
          ...
          <article className="card">
            ...
            <p className="text-secondary">
              Tasks assigned by the Training & Placement Officer (TPO).
            </p>
            <ul className="action-list" style={{ marginTop: '14px' }}>
              <li>Mark attendance for Aptitude Training Slot (Batch B) at 2:00 PM</li>
              <li>
                Collect resumes of pending CSE students for Graduate Engineer recruitment
              </li>
              <li>
                Verify that Aadhaar/PAN compliance documents are updated on student
                profiles
              </li>
              <li>
                Assistance roster: Prepare event announcement cards for upcoming Google
                Seminar
              </li>
            </ul>
          </article>
          ...
          <article
            className="card"
            style={{ alignContent: 'start', display: 'grid', gap: '12px' }}
          >
            <h2>Operational Shortcuts</h2>
            <p className="text-secondary">
              Direct links to take class or company lists attendance.
            </p>
            <div style={{ display: 'grid', gap: '10px' }}>
              <Link
                to="/training"
      ...
      <div style={{ display: 'grid', gap: 'var(--space-lg)' }}>
        <section className="page-header">
          <div>
            ...
            <p className="text-secondary">
              Overview of placement funnels, campus training benchmarks, and student
              statistics.
            </p>
          </div>
          <div className="quick-actions">
            ...
            <Link to="/placements" className="btn-success button-link">
              Create Job Opening
            </Link>
          </div>
        </section>
        ...
        <section className="dashboard-grid" style={{ gridTemplateColumns: '1fr 1fr' }}>
          <article className="card">
            ...
            <p className="text-secondary" style={{ marginBottom: '16px' }}>
              Percentage of registered student batch placed by branch.
            </p>
          ...
          <article className="card">
            ...
            <p className="text-secondary" style={{ marginBottom: '16px' }}>
              Student turnout trends for soft skills training.
            </p>
            <div
              style={{
                display: 'flex',
        ...
        <section className="dashboard-grid">
          ...
          <article className="card">
            ...
            <p className="text-secondary">
              Administrative tasks awaiting review or execution.
            </p>
            <ul className="action-list" style={{ marginTop: '14px' }}>
              <li>Approve pending student registrations (14 profiles outstanding)</li>
              <li>
                Publish final eligibility list for Microsoft campus recruitment drive
              </li>
